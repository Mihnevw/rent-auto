          ...
          articles: [
            {
              number: "Чл.1.",
              content:
                "НАЕМАТЕЛЯТ е длъжен да притежава редовни и валидни лични документи: паспорт/лична карта, свидетелство за управление на МПС и контролен талон със стаж не по-малко от 3 години и минимална възраст от 21 навършени години. Само записаните в настоящия договор лица (НАЕМАТЕЛЯТ И ДОПЪЛНИТЕЛНИЯТ ШОФЬОР) могат да управляват наетия автомобил. В случай на управление от друго лице, неписано в договора за наем, НАЕМАТЕЛЯТ носи пълната отговорност за стойността на автомобила и възникналите допълнителни разходи без значение на заплатените такси за освобождаване от отговорност или допълнителни покрития.",
            },
            {
              number: "Чл. 1.1",
              content:
                "Минимален срок за отдаване на автомобила под наем 2 дни ( 48 часа ). Не се позволява залепяне и закачване на каквито и да било украси, реклами и др. елементи по боята на автомобила. За тържества, сватби и балове, цените за наем на автомобилите са по договаряне.",
            },
          ],
        },
      },
          ...
          <div className="prose max-w-none text-gray-700 leading-relaxed">
            ...
            {language === "bg" && (
              <>
                <p className="mb-4">
                  ...
                  има всички необходими документи и съответните категории да управлява наетия автомобил. НАЕМАТЕЛЯТ е
            ...
            <div className="mt-8 pt-6 border-t border-gray-200">
              <p className="text-sm text-gray-600 text-center">
                {language === "bg"
                  ? "Този документ представлява пълните общи условия за наем на автомобили от DL RENT EOOD."
